<?php
/**
 * Ajouter une mission (Recruteur)
 * SunuJob Étudiant
 */

$pageTitle = 'Publier une mission - SunuJob Étudiant';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erreurs)) {
        $stmt = $conn->prepare("
            INSERT INTO missions (recruteur_id, categorie_id, titre, description, localisation, type_mission, remuneration, date_debut, date_fin, jours_travail, heures_travail, places_disponibles)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
        ...
        if ($stmt->execute()) {
            $_SESSION['flash_message'] = "Mission publiée avec succès !";
            $_SESSION['flash_type'] = 'success';
            header('Location: /pages/recruteur/mes-missions.php');
            exit;
        } else {
            $erreurs[] = "Erreur lors de la publication de la mission.";
        }
    }
}
...
<div class="page-header">
    <div class="container">
        <h1><i class="fas fa-plus-circle me-2"></i>Publier une mission</h1>
                ...
                <form method="POST" action="">
                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-3">
                            ...
                            <input type="text" class="form-control" id="titre" name="titre" value="<?= htmlspecialchars($donnees['titre']) ?>" required placeholder="Ex: Assistant événementiel pour concert">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="5" maxlength="800" required placeholder="Décrivez en détail la mission, les tâches à effectuer, les compétences requises..."><?= htmlspecialchars($donnees['description']) ?></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="localisation" name="localisation" value="<?= htmlspecialchars($donnees['localisation']) ?>" required placeholder="Ex: Dakar, Plateau">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="remuneration" name="remuneration" value="<?= htmlspecialchars($donnees['remuneration']) ?>" min="0" placeholder="Ex: 15000">
                        </div>
                        <div class="col-md-4 mb-3">
