...
| `role` | ENUM('etudiant', 'recruteur') | NOT NULL | Rôle de l'utilisateur |
...
| `statut` | ENUM('active', 'fermee', 'expiree') | DEFAULT 'active' | Statut de l'annonce |
...
| `statut` | ENUM('en_attente', 'acceptee', 'refusee') | DEFAULT 'en_attente' | Statut de la candidature |
...
CREATE TABLE utilisateurs (
    ...
    role ENUM('etudiant', 'recruteur') NOT NULL,
    photo VARCHAR(255),
