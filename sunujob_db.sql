...
CREATE TABLE `abonnements` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_utilisateur_statut` (`utilisateur_id`,`statut`),
  CONSTRAINT `abonnements_ibfk_1` FOREIGN KEY (`utilisateur_id`) REFERENCES `utilisateurs` (`id`) ON DELETE CASCADE
...
INSERT INTO `abonnements` VALUES (4,1,'mensuel',2000.00,'2026-07-15','2026-08-14','actif','wave','SUB-680DC984D9E6','2026-07-15 14:38:37','2026-07-15 14:38:37');
...
CREATE TABLE `paiements` (
  ...
  `reference_wave` varchar(150) DEFAULT NULL,
  ...
  KEY `idx_reference_wave` (`reference_wave`),
  CONSTRAINT `paiements_ibfk_1` FOREIGN KEY (`utilisateur_id`) REFERENCES `utilisateurs` (`id`) ON DELETE CASCADE,
  CONSTRAINT `paiements_ibfk_2` FOREIGN KEY (`abonnement_id`) REFERENCES `abonnements` (`id`) ON DELETE SET NULL
...
INSERT INTO `paiements` VALUES (3,1,NULL,2000.00,'XOF','wave','DEMO-36163E5A584F',NULL,'en_attente',NULL,'2026-07-14 17:30:11','2026-07-14 17:30:11'),(4,1,NULL,2000.00,'XOF','wave','DEMO-DEF442707AEB',NULL,'en_attente',NULL,'2026-07-14 17:31:22','2026-07-14 17:31:22'),(5,1,NULL,2000.00,'XOF','wave','DEMO-4A45C5795A88',NULL,'en_attente',NULL,'2026-07-15 10:50:43','2026-07-15 10:50:43'),(7,1,NULL,2000.00,'XOF','wave','DEMO-CEAD0DABC8B2',NULL,'en_attente',NULL,'2026-07-15 11:06:24','2026-07-15 11:06:24'),(8,1,NULL,2000.00,'XOF','wave','DEMO-88E9FC26EB72',NULL,'en_attente',NULL,'2026-07-15 11:06:34','2026-07-15 11:06:34'),(9,1,NULL,2000.00,'XOF','wave','SUB-997CACE185EA',NULL,'en_attente',NULL,'2026-07-15 11:14:07','2026-07-15 11:14:07'),(11,1,NULL,2000.00,'XOF','wave','SUB-E785ACA2A2AA',NULL,'en_attente',NULL,'2026-07-15 14:12:11','2026-07-15 14:12:11'),(12,1,4,2000.00,'XOF','wave','SUB-680DC984D9E6',NULL,'paye','2026-07-15 14:38:37','2026-07-15 14:37:40','2026-07-15 14:38:37');
...
INSERT INTO `parametres` VALUES (1,'wave_lien_partage','https://pay.wave.com/m/M_sn__DrKiUmNBO9_/c/sn/','2026-07-15 11:13:04');
...
-- Dump completed on 2026-07-15 15:02:43
